          ...
          <div className="flex flex-col gap-2 py-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="px-3 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 text-sm flex items-center justify-center gap-1"
              >
                <Plus className="w-4 h-4" /> Приход
              </button>
              <button
                onClick={() => navigate('/warehouse/expense/new')}
                className="px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm flex items-center justify-center gap-1"
              >
